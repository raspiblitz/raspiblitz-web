  ...
  return (
    <div className='p-5 h-full'>
      <div className='bd-card h-full'>
        <div className='rounded bg-yellow-400 text-black flex flex-col lg:flex-row flex-wrap p-10 shadow-md'>
        ...
        <div className='flex justify-around p-2'>
          <button
            ...
            className='h-10 w-5/12 bg-black text-white p-4 rounded flex justify-center items-center'
          >
