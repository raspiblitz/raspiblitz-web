...
export class Home extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:4000/syncstatus').then((res) => this.setState({
    ...
    return (
      <React.Fragment>
        <div className='content-container w-full bg-gray-300 dark:bg-gray-600 dark:text-white transition-colors'>
          <div className='py-8'>
          <dl className="mx-5 mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
            ...
            <div className='flex flex-col md:flex-row flex-wrap lg:flex-nowrap w-full items-start'>
              <DashboardBox
                ...
                transactionBox
                balance={this.state.btcBalance || this.state.btcBalance === 0 ? this.state.btcBalance + " BTC": undefined}
