  ...
  return (
    <SetupContainer>
      <form onSubmit={handleSubmit(callback)}>
        <section className="flex h-full flex-col items-center justify-center gap-y-10 md:p-8">
          ...
          <h4 className="w-2/5 rounded-xl border border-warning bg-yellow-900 p-4 text-center font-semibold text-warning">
            {t("setup.final_seedwords")}
          </h4>

          {seedWords && (
            <ol className="flex h-[26rem] w-2/5 list-decimal flex-col flex-wrap gap-x-8 rounded-3xl bg-default pl-20 pt-3 font-bold lowercase">
              {words.map((word, i) => {
                return (
