...
const ModalDialog: FC<Props> = ({ closeable = true, close, children }) => {
  ...
  return (
    <ModalBackground>
      <div className="xl:max-w-screen-sm mx-5 flex h-auto max-h-[100%] w-4/5 flex-col overflow-y-auto rounded-lg bg-white text-center dark:bg-gray-800 dark:text-white lg:w-1/2 xl:w-2/5">
